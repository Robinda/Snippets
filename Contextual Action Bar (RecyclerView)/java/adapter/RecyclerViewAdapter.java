...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (modelList.get(position).getColored())
    ...
    /**
     * Gestion du tableau des items sélectionnés
     * @param pos Position de l'élément
     */
    public void toggleSelection(int pos) {
        currentSelectedIndex = pos;

        // Si déjà présent dans le tableau des items sélectionnés, on le supprime
    ...
    /**
     * Ajout de tous les éléments de la liste au tableau des items selectionnés
     */
    ...
    /**
     * Met en surbrillance l'item selectionné
     * @param position Position de l'item
     */
    public void updateData(int position) {
        modelList.get(position).setColored(true);
        resetCurrentIndex();
    }
